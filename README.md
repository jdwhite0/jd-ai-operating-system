...
[![Version](https://img.shields.io/badge/version-1.0.0-FFC20E?style=for-the-badge&labelColor=002244)](CHANGELOG.md)
[![License](https://img.shields.io/badge/license-Proprietary-002244?style=for-the-badge&labelColor=000000)](LICENSE)
...
```mermaid
flowchart LR
    A[AI_START_HERE] --> B[Today's State]
    B --> C[System Rules]
    C --> D[Your Brain<br/>source of truth]
    D --> E[Act]
    E --> F[Report]
    F --> B
```
